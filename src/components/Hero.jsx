    ...
    <div className='text-white flex justify-center items-center h-[80vh]' >
      <div className='max-w-[800px] w-full text-center flex flex-col ' >
          ...
          <p className='md:text-2xl text-xl font-bold text-gray-500
           px-2 xl:mt-2 md:mt-none ' >Monitor your data analytics to increase revenue for BTB,
            BTC & SASS platforms.</p>
            <button className='bg-[#00df9a] w-[200px] mx-auto my-6 font-medium py-3 rounded-md hover:bg-[#43c79d] hover:scale-105 transform duration-300 text-black ' > Get Started</button>
      </div>
    </div>
  )
}
